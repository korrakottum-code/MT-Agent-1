...
อัปเดตล่าสุด: 1 ก.ย. 2026 18:20 — ข้อสอบผ่าน 8/8
...
| MVP 1.0 — AI Organization | ~10% | ยังไม่เริ่มจริงจัง |

**ถึงเป้าหมายปลายทาง (MVP 1.0) ประมาณ 30%**
...
## MVP 1.0 — 1.5/14 ข้อ (~10%)

- [x] Corporate Search (บางส่วน — ค้นข้อความข้ามกลุ่มได้ ยังไม่รวมเอกสาร)
...
1. อ่านไฟล์เอกสาร (PDF/Word/Excel) — ปลดล็อกเคส "โยนสรุปประชุมให้แตกเป็นงาน"
2. Event Extraction → เปิดทาง MVP 0.3 (ควรรอข้อมูลจริง 1–2 สัปดาห์)
